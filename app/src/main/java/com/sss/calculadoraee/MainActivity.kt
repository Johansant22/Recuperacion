...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            R.id.cero -> ingresaNumber("0")
            R.id.btnuno -> ingresaNumber("1")
            R.id.btndos -> ingresaNumber("2")
            R.id.btntres -> ingresaNumber("3")
            R.id.btncua -> ingresaNumber("4")
            R.id.btncinco -> ingresaNumber("5")
            R.id.btnseis -> ingresaNumber("6")
            R.id.btnsie -> ingresaNumber("7")
            R.id.btnoch -> ingresaNumber("8")
            R.id.btnnue -> ingresaNumber("9")
            R.id.btnMas -> operadorMath("+")
            R.id.btnmenos -> operadorMath("-")
            R.id.btnMult -> operadorMath("*")
            R.id.btndiv -> operadorMath("/")
    ...
    private fun ingresaNumber(number: String) {
        binding.txtcaja.append(number)
    }
    private fun operadorMath(operator: String) {
